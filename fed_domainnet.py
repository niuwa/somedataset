...
def prepare_data(args):
    ...
    cross_domain_trainsets = [clipart_trainset, infograph_trainset, painting_trainset, quickdraw_trainset, real_trainset, sketch_trainset]
    # cross_domain_trainsets = [clipart_trainset, quickdraw_trainset, sketch_trainset]

    # set cross domain freqs to each dataset
    clipart_trainset.set_cross_domain_trainsets(cross_domain_trainsets)
    infograph_trainset.set_cross_domain_trainsets(cross_domain_trainsets)
    painting_trainset.set_cross_domain_trainsets(cross_domain_trainsets)
    quickdraw_trainset.set_cross_domain_trainsets(cross_domain_trainsets)
    real_trainset.set_cross_domain_trainsets(cross_domain_trainsets)
    sketch_trainset.set_cross_domain_trainsets(cross_domain_trainsets)
    ...
    # min_data_len = min(len(clipart_trainset), len(quickdraw_trainset), len(sketch_trainset))
    ...
    # train_loaders = [clipart_train_loader, quickdraw_train_loader, sketch_train_loader]
    # val_loaders = [clipart_val_loader, quickdraw_val_loader, sketch_val_loader]
    # test_loaders = [clipart_test_loader,quickdraw_test_loader, sketch_test_loader]
...
if __name__ == '__main__':
    ...
    # datasets = ['Clipart', 'Quickdraw', 'Sketch']
