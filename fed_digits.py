...
def prepare_data(args):
    ...
    train_loaders = [svhn_train_loader, mnist_train_loader, usps_train_loader, synth_train_loader, mnistm_train_loader]
    test_loaders  = [svhn_test_loader, mnist_test_loader, usps_test_loader, synth_test_loader, mnistm_test_loader]
